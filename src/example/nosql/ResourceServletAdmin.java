			...
			try {
				...
				for (HashMap doc : allDocs) {
				   ...
				   jsonObject = new JsonObject();
					...
					jsonObject.addProperty("idescription", objstage.get("description") + "");
					jsonObject.addProperty("ipwcode", objstage.get("pwcode") + "");
					jsonObject.addProperty("iunit", objstage.get("unit") + "");
					jsonObject.addProperty("isubunit", objstage.get("subunit") + "");
					jsonObject.addProperty("ijobrole", objstage.get("jobrole") + "");
					jsonObject.addProperty("iskill", objstage.get("skill") + "");
